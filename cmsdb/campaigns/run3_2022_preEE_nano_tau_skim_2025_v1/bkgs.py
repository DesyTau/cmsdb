...
dataset_rows = [
  ("GluGluHto2Tau_UncorrelatedDecay_SM_UnFiltered_ProdAndDecay",  ["/GluGluHto2Tau_UncorrelatedDecay_SM_UnFiltered_ProdAndDecay"],    158678,   1, 2693954882, "h_ggf_htt"            ),
  ("VBFHto2Tau_UncorrelatedDecay_UnFiltered",                     ["/VBFHto2Tau_UncorrelatedDecay_UnFiltered"],                        99878,   1,  896795747, "h_vbf_htt"            ),
  ("DYto2L_M_10to50_amcatnloFXFX",                                ["/DYto2L_M_10to50_amcatnloFXFX"],                                52363920,  48, 2602844442, "dy_m10to50"           ),
  ("DYto2L_M_50_0J_amcatnloFXFX",                                 ["/DYto2L_M_50_0J_amcatnloFXFX"],                                 70152268, 120, 2577421953, "dy_m50toinf_0j"       ),
  ("DYto2L_M_50_1J_amcatnloFXFX",                                 ["/DYto2L_M_50_1J_amcatnloFXFX"],                                 45431665, 171,  542870889, "dy_m50toinf_1j"       ),
  ("DYto2L_M_50_2J_amcatnloFXFX",                                 ["/DYto2L_M_50_2J_amcatnloFXFX"],                                 21946124, 154,  824633104, "dy_m50toinf_2j"       ),
  ("DYto2L_M_50_amcatnloFXFX",                                    ["/DYto2L_M_50_amcatnloFXFX"],                                    48541588, 117, 3909617802, "dy_m50toinf"          ),
  ("DYto2L_M_50_amcatnloFXFX_ext1",                               ["/DYto2L_M_50_amcatnloFXFX_ext1"],                               66755726, 157, 2411443415, "dy_m50toinf"          ),
  ("DYto2Tau_MLL_50_0J_amcatnloFXFX",                             ["/DYto2Tau_MLL_50_0J_amcatnloFXFX"],                             31651962,  37,  936866557, "dy_tautau_m50toinf_0j"),
  ("DYto2Tau_MLL_50_1J_amcatnloFXFX",                             ["/DYto2Tau_MLL_50_1J_amcatnloFXFX"],                             25513383,  70, 2385291541, "dy_tautau_m50toinf_1j"),
  ("DYto2Tau_MLL_50_2J_amcatnloFXFX",                             ["/DYto2Tau_MLL_50_2J_amcatnloFXFX"],                             32763798, 182, 2672935788, "dy_tautau_m50toinf_2j"),
  ...
  ("WminusHto2Tau_UncorrelatedDecay_UnFiltered",                  ["/WminusHto2Tau_UncorrelatedDecay_UnFiltered"],                     27789,   1, 1056944567, "w_minus_h_htt_UU"     ),
  ("WplusHto2Tau_UncorrelatedDecay_UnFiltered",                   ["/WplusHto2Tau_UncorrelatedDecay_UnFiltered"],                      28300,   1, 1400713916, "w_plus_h_htt_UU"      ),
  ("WtoLNu_amcatnloFXFX",                                         ["/WtoLNu_amcatnloFXFX"],                                         55638210,  84, 3758145551, "w_lnu"                ),
  ("ZHto2Tau_UncorrelatedDecay_UnFiltered",                       ["/ZHto2Tau_UncorrelatedDecay_UnFiltered"],                          28992,   1, 4033200945, "zh_htt_UU"            ),
